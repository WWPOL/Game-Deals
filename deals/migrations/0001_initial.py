# Generated by Django 5.2.9 on 2026-01-01 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Game image (required when published)', null=True, upload_to='game_images/%Y/%m/')),
                ('image_attribution', models.URLField(blank=True, help_text='Source URL for image attribution (optional)', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_notify', models.BooleanField(default=False, help_text='Automatically send notifications when new deals are published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('webhook_url', models.URLField(help_text='Discord webhook URL (from Server Settings -> Integrations -> Webhooks)', max_length=500)),
