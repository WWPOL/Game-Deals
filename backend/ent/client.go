...
import (
	...
	"github.com/WWPOL/Game-Deals/backend/ent/migrate"
...
// QueryImage queries the image edge of a Deal.
func (c *DealClient) QueryImage(d *Deal) *ImageQuery {
...
// QueryCreatedBy queries the created_by edge of a Deal.
func (c *DealClient) QueryCreatedBy(d *Deal) *UserQuery {
...
type (
	hooks struct {
		Deal, Image, User []ent.Hook
	}
	inters struct {
		Deal, Image, User []ent.Interceptor
	}
)
