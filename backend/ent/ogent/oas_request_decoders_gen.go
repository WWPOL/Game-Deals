...
func (s *Server) decodeCreateDealRequest(r *http.Request) (
	req *CreateDealReq,
	close func() error,
	rerr error,
) {
...
func (s *Server) decodeUpdateDealRequest(r *http.Request) (
	req *UpdateDealReq,
	close func() error,
	rerr error,
) {
...
func (s *Server) decodeUpdateImageRequest(r *http.Request) (
	req jx.Raw,
	close func() error,
	rerr error,
) {
